...
# SancaklarUsersBot - ByMisakiMey - SancaklarMedias 
#
			...
			if sleep_t == "":
				...
				if sec == "":
					...
					if sec.lower() == "edit":
						...
						await q.client.send_file(q.chat_id, f"./SancaklarUsersBot{dosya_name}.py", force_document=True, caption="Bu Plugin @SancaklarUsersBot Tarafından Yapılmıştır..")
						await q.delete()
						os.remove(f"./SancaklarUsersBot{dosya_name}.py")
						return
...
c_ = c("pluginmaker")
c_.add_command("pmake", "<pluginin_komutu> <plugin_hızı> <edit/alt/foto/muzik> ", "@SancaklarUsersBot Sizin İçin Bir plugin Oluşturur...")
